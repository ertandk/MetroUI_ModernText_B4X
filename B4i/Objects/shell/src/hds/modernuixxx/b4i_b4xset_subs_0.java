...
public class b4i_b4xset_subs_0 {


public static RemoteObject  _add(RemoteObject __ref,RemoteObject _value) throws Exception{
try {
		Debug.PushSubsStack("Add (b4xset) ","b4xset",8,__ref.getField(false, "bi"),__ref,9);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_map" /*RemoteObject*/ ).runClassMethod (b4i_b4xorderedmap.class, "_put::" /*RemoteObject*/ ,(Object)(_value),(Object)((RemoteObject.createImmutable(""))));
...
try {
		Debug.PushSubsStack("AsList (b4xset) ","b4xset",8,__ref.getField(false, "bi"),__ref,29);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_map" /*RemoteObject*/ ).runClassMethod (b4i_b4xorderedmap.class, "_getkeys" /*RemoteObject*/ );
...
b4i_b4xset._map = RemoteObject.createNew ("b4i_b4xorderedmap");__ref.setField("_map",b4i_b4xset._map);
 //BA.debugLineNum = 3;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _clear(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("Clear (b4xset) ","b4xset",8,__ref.getField(false, "bi"),__ref,25);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_map" /*RemoteObject*/ ).runClassMethod (b4i_b4xorderedmap.class, "_clear" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Contains (b4xset) ","b4xset",8,__ref.getField(false, "bi"),__ref,17);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_map" /*RemoteObject*/ ).runClassMethod (b4i_b4xorderedmap.class, "_containskey:" /*RemoteObject*/ ,(Object)(_value));
...
try {
		Debug.PushSubsStack("getSize (b4xset) ","b4xset",8,__ref.getField(false, "bi"),__ref,21);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_map" /*RemoteObject*/ ).runClassMethod (b4i_b4xorderedmap.class, "_getsize" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Initialize (b4xset) ","b4xset",8,__ref.getField(false, "bi"),__ref,5);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_map" /*RemoteObject*/ ).runClassMethod (b4i_b4xorderedmap.class, "_initialize:" /*RemoteObject*/ ,__ref.getField(false, "bi"));
...
try {
		Debug.PushSubsStack("Remove (b4xset) ","b4xset",8,__ref.getField(false, "bi"),__ref,13);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_map" /*RemoteObject*/ ).runClassMethod (b4i_b4xorderedmap.class, "_remove:" /*RemoteObject*/ ,(Object)(_value));
