...
try {
		Debug.PushSubsStack("Clear (b4xbitset) ","b4xbitset",4,__ref.getField(false, "bi"),__ref,53);
...
try {
		Debug.PushSubsStack("Get (b4xbitset) ","b4xbitset",4,__ref.getField(false, "bi"),__ref,38);
...
Debug.JustUpdateDeviceLine();
_offset = b4i_main.__c.runMethod(false,"Bit").runMethod(true,"And::",(Object)(BA.numberCast(int.class, ((int)0x0000001f))),(Object)(_index));Debug.locals.put("offset", _offset);Debug.locals.put("offset", _offset);
...
try {
		Debug.PushSubsStack("getSize (b4xbitset) ","b4xbitset",4,__ref.getField(false, "bi"),__ref,49);
...
try {
		Debug.PushSubsStack("Initialize (b4xbitset) ","b4xbitset",4,__ref.getField(false, "bi"),__ref,10);
...
try {
		Debug.PushSubsStack("Set (b4xbitset) ","b4xbitset",4,__ref.getField(false, "bi"),__ref,16);
