...
try {
		Debug.PushSubsStack("Button1_Click (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "bi"),__ref,27);
...
_hatavar = __ref.runClassMethod (b4i_b4xmainpage.class, "_text_kontrol:::" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_name_text" /*RemoteObject*/ )),(Object)(BA.ObjectToString("Please fill in the Name !")),(Object)(_hatavar));Debug.locals.put("Hatavar", _hatavar);
 BA.debugLineNum = 30;BA.debugLine="Hatavar=Text_Kontrol(Surname_Text,\"Please fill in";
Debug.ShouldStop(536870912);
_hatavar = __ref.runClassMethod (b4i_b4xmainpage.class, "_text_kontrol:::" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_surname_text" /*RemoteObject*/ )),(Object)(BA.ObjectToString("Please fill in the Surname !")),(Object)(_hatavar));Debug.locals.put("Hatavar", _hatavar);
 BA.debugLineNum = 31;BA.debugLine="Hatavar=Text_Kontrol(Email_Text,\"Please fill in t";
Debug.ShouldStop(1073741824);
_hatavar = __ref.runClassMethod (b4i_b4xmainpage.class, "_text_kontrol:::" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_email_text" /*RemoteObject*/ )),(Object)(BA.ObjectToString("Please fill in the E-Mail !")),(Object)(_hatavar));Debug.locals.put("Hatavar", _hatavar);
...
b4i_b4xmainpage._name_text = RemoteObject.createNew ("b4i_metroui_moderntext");__ref.setField("_name_text",b4i_b4xmainpage._name_text);
 //BA.debugLineNum = 11;BA.debugLine="Private Surname_Text As MetroUI_ModernText";
b4i_b4xmainpage._surname_text = RemoteObject.createNew ("b4i_metroui_moderntext");__ref.setField("_surname_text",b4i_b4xmainpage._surname_text);
 //BA.debugLineNum = 12;BA.debugLine="Private Email_Text As MetroUI_ModernText";
b4i_b4xmainpage._email_text = RemoteObject.createNew ("b4i_metroui_moderntext");__ref.setField("_email_text",b4i_b4xmainpage._email_text);
...
try {
		Debug.PushSubsStack("Text_Kontrol (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "bi"),__ref,34);
...
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("=",_textbox.runClassMethod (b4i_metroui_moderntext.class, "_gettext" /*RemoteObject*/ ),BA.ObjectToString(""))) { 
 BA.debugLineNum = 36;BA.debugLine="TextBox.ShowError(HataMesajı)";
Debug.ShouldStop(8);
_textbox.runClassMethod (b4i_metroui_moderntext.class, "_showerror:" /*RemoteObject*/ ,(Object)(_hatamesajı));
...
Debug.ShouldStop(16384);
if (RemoteObject.solveBoolean("=",_hatavar,b4i_main.__c.runMethod(true,"True"))) { 
