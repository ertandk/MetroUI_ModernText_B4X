...
public class b4i_b4xbytesbuilder_subs_0 {


public static RemoteObject  _append(RemoteObject __ref,RemoteObject _data) throws Exception{
try {
		Debug.PushSubsStack("Append (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "bi"),__ref,24);
...
Debug.JustUpdateDeviceLine();
_oldlength = __ref.runClassMethod (b4i_b4xbytesbuilder.class, "_changelength:" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mlength" /*RemoteObject*/ ),_data.getField(true,"Length")}, "+",1, 1)));Debug.locals.put("OldLength", _oldlength);Debug.locals.put("OldLength", _oldlength);
 BA.debugLineNum = 26;BA.debugLine="Bit.ArrayCopy(Data, 0, mBuffer, OldLength, Data.L";
Debug.JustUpdateDeviceLine();
b4i_main.__c.runMethod(false,"Bit").runVoidMethod ("ArrayCopy:::::",(Object)(_data),(Object)(BA.numberCast(int.class, 0)),(Object)(__ref.getField(false,"_mbuffer" /*RemoteObject*/ )),(Object)(_oldlength),(Object)(_data.getField(true,"Length")));
...
try {
		Debug.PushSubsStack("Append2 (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "bi"),__ref,33);
...
Debug.JustUpdateDeviceLine();
_oldlength = __ref.runClassMethod (b4i_b4xbytesbuilder.class, "_changelength:" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mlength" /*RemoteObject*/ ),_length}, "+",1, 1)));Debug.locals.put("OldLength", _oldlength);Debug.locals.put("OldLength", _oldlength);
 BA.debugLineNum = 35;BA.debugLine="Bit.ArrayCopy(Data, StartIndex, mBuffer, OldLengt";
Debug.JustUpdateDeviceLine();
b4i_main.__c.runMethod(false,"Bit").runVoidMethod ("ArrayCopy:::::",(Object)(_data),(Object)(_startindex),(Object)(__ref.getField(false,"_mbuffer" /*RemoteObject*/ )),(Object)(_oldlength),(Object)(_length));
...
try {
		Debug.PushSubsStack("ChangeLength (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "bi"),__ref,12);
...
Debug.JustUpdateDeviceLine();
_b = RemoteObject.createNew("B4IArray").runMethod(false, "initBytes:", (Object)new RemoteObject[] {BA.numberCast(int.class, b4i_main.__c.runMethod(true,"Max::",(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mbuffer" /*RemoteObject*/ ).getField(true,"Length"),RemoteObject.createImmutable(2)}, "*",0, 1))),(Object)(BA.numberCast(double.class, _newlength))))});Debug.locals.put("b", _b);
 BA.debugLineNum = 17;BA.debugLine="Bit.ArrayCopy(mBuffer, 0, b, 0, mBuffer.Length)";
Debug.JustUpdateDeviceLine();
b4i_main.__c.runMethod(false,"Bit").runVoidMethod ("ArrayCopy:::::",(Object)(__ref.getField(false,"_mbuffer" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, 0)),(Object)(_b),(Object)(BA.numberCast(int.class, 0)),(Object)(__ref.getField(false,"_mbuffer" /*RemoteObject*/ ).getField(true,"Length")));
...
b4i_b4xbytesbuilder._mbuffer = RemoteObject.createNew("B4IArray").runMethod(false, "initBytes:", (Object)new RemoteObject[] {BA.numberCast(int.class, 0)});__ref.setField("_mbuffer",b4i_b4xbytesbuilder._mbuffer);
 //BA.debugLineNum = 3;BA.debugLine="Private mLength As Int";
b4i_b4xbytesbuilder._mlength = RemoteObject.createImmutable(0);__ref.setField("_mlength",b4i_b4xbytesbuilder._mlength);
 //BA.debugLineNum = 4;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _clear(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("Clear (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "bi"),__ref,39);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xbytesbuilder.class, "_changelength:" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));
...
try {
		Debug.PushSubsStack("getInternalBuffer (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "bi"),__ref,104);
...
try {
		Debug.PushSubsStack("getLength (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "bi"),__ref,94);
...
try {
		Debug.PushSubsStack("IndexOf (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "bi"),__ref,109);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4i_b4xbytesbuilder.class, "_indexof2::" /*RemoteObject*/ ,(Object)(_searchfor),(Object)(BA.numberCast(int.class, 0)));
...
try {
		Debug.PushSubsStack("IndexOf2 (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "bi"),__ref,114);
...
{
final int step1 = 1;
final int limit1 = RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mlength" /*RemoteObject*/ ),_searchfor.getField(true,"Length")}, "-",1, 1).<Number>get().intValue();
_i1 = _index.<Number>get().intValue() ;
...
{
final int step2 = 1;
final int limit2 = RemoteObject.solve(new RemoteObject[] {_searchfor.getField(true,"Length"),RemoteObject.createImmutable(1)}, "-",1, 1).<Number>get().intValue();
_i2 = 0 ;
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",_searchfor.runMethod(true,"getByteFast:", BA.numberCast(int.class, _i2)),BA.numberCast(double.class, __ref.getField(false,"_mbuffer" /*RemoteObject*/ ).runMethod(true,"getByteFast:", RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(_i1),RemoteObject.createImmutable(_i2)}, "+",1, 1))))) { 
...
try {
		Debug.PushSubsStack("Initialize (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "bi"),__ref,6);
...
Debug.JustUpdateDeviceLine();
b4i_b4xbytesbuilder._mbuffer = RemoteObject.createNew("B4IArray").runMethod(false, "initBytes:", (Object)new RemoteObject[] {BA.numberCast(int.class, 100)});__ref.setField("_mbuffer",b4i_b4xbytesbuilder._mbuffer);
...
try {
		Debug.PushSubsStack("Insert (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "bi"),__ref,45);
...
b4i_main.__c.runVoidMethod ("LogImpl:::","93407874",RemoteObject.createImmutable("Index too large"),0);};
 BA.debugLineNum = 48;BA.debugLine="Append(Data)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xbytesbuilder.class, "_append:" /*RemoteObject*/ ,(Object)(_data));
 }else {
 BA.debugLineNum = 50;BA.debugLine="Dim AfterIndex() As Byte = SubArray(Index)";
Debug.JustUpdateDeviceLine();
_afterindex = __ref.runClassMethod (b4i_b4xbytesbuilder.class, "_subarray:" /*RemoteObject*/ ,(Object)(_index));Debug.locals.put("AfterIndex", _afterindex);Debug.locals.put("AfterIndex", _afterindex);
 BA.debugLineNum = 51;BA.debugLine="ChangeLength(mLength + Data.Length)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xbytesbuilder.class, "_changelength:" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mlength" /*RemoteObject*/ ),_data.getField(true,"Length")}, "+",1, 1)));
 BA.debugLineNum = 52;BA.debugLine="Bit.ArrayCopy(Data, 0, mBuffer, Index, Data.Leng";
Debug.JustUpdateDeviceLine();
b4i_main.__c.runMethod(false,"Bit").runVoidMethod ("ArrayCopy:::::",(Object)(_data),(Object)(BA.numberCast(int.class, 0)),(Object)(__ref.getField(false,"_mbuffer" /*RemoteObject*/ )),(Object)(_index),(Object)(_data.getField(true,"Length")));
 BA.debugLineNum = 53;BA.debugLine="Bit.ArrayCopy(AfterIndex, 0, mBuffer, Index + Da";
Debug.JustUpdateDeviceLine();
b4i_main.__c.runMethod(false,"Bit").runVoidMethod ("ArrayCopy:::::",(Object)(_afterindex),(Object)(BA.numberCast(int.class, 0)),(Object)(__ref.getField(false,"_mbuffer" /*RemoteObject*/ )),(Object)(RemoteObject.solve(new RemoteObject[] {_index,_data.getField(true,"Length")}, "+",1, 1)),(Object)(_afterindex.getField(true,"Length")));
 };
...
try {
		Debug.PushSubsStack("Remove (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "bi"),__ref,71);
...
Debug.JustUpdateDeviceLine();
_res = __ref.runClassMethod (b4i_b4xbytesbuilder.class, "_subarray2::" /*RemoteObject*/ ,(Object)(_beginindex),(Object)(_endindex));Debug.locals.put("res", _res);Debug.locals.put("res", _res);
...
Debug.JustUpdateDeviceLine();
_afterendindex = __ref.runClassMethod (b4i_b4xbytesbuilder.class, "_subarray:" /*RemoteObject*/ ,(Object)(_endindex));Debug.locals.put("AfterEndIndex", _afterendindex);Debug.locals.put("AfterEndIndex", _afterendindex);
 BA.debugLineNum = 75;BA.debugLine="Bit.ArrayCopy(AfterEndIndex, 0, mBuffer, BeginIn";
Debug.JustUpdateDeviceLine();
b4i_main.__c.runMethod(false,"Bit").runVoidMethod ("ArrayCopy:::::",(Object)(_afterendindex),(Object)(BA.numberCast(int.class, 0)),(Object)(__ref.getField(false,"_mbuffer" /*RemoteObject*/ )),(Object)(_beginindex),(Object)(_afterendindex.getField(true,"Length")));
 };
 BA.debugLineNum = 77;BA.debugLine="ChangeLength(mLength - (EndIndex - BeginIndex))";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xbytesbuilder.class, "_changelength:" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_mlength" /*RemoteObject*/ ),(RemoteObject.solve(new RemoteObject[] {_endindex,_beginindex}, "-",1, 1))}, "-",1, 1)));
...
try {
		Debug.PushSubsStack("Set (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "bi"),__ref,58);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_index,BA.numberCast(double.class, __ref.getField(true,"_mlength" /*RemoteObject*/ )))) { 
b4i_main.__c.runVoidMethod ("LogImpl:::","93473410",RemoteObject.createImmutable("Index too large"),0);};
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4i_b4xbytesbuilder.class, "_changelength:" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {_data.getField(true,"Length"),_index}, "+",1, 1)));
 };
...
try {
		Debug.PushSubsStack("SubArray (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "bi"),__ref,82);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4i_b4xbytesbuilder.class, "_subarray2::" /*RemoteObject*/ ,(Object)(_beginindex),(Object)(__ref.getField(true,"_mlength" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("SubArray2 (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "bi"),__ref,88);
...
Debug.JustUpdateDeviceLine();
_b = RemoteObject.createNew("B4IArray").runMethod(false, "initBytes:", (Object)new RemoteObject[] {RemoteObject.solve(new RemoteObject[] {_endindex,_beginindex}, "-",1, 1)});Debug.locals.put("b", _b);
 BA.debugLineNum = 90;BA.debugLine="Bit.ArrayCopy(mBuffer, BeginIndex, b, 0, b.Length";
Debug.JustUpdateDeviceLine();
b4i_main.__c.runMethod(false,"Bit").runVoidMethod ("ArrayCopy:::::",(Object)(__ref.getField(false,"_mbuffer" /*RemoteObject*/ )),(Object)(_beginindex),(Object)(_b),(Object)(BA.numberCast(int.class, 0)),(Object)(_b.getField(true,"Length")));
...
try {
		Debug.PushSubsStack("ToArray (b4xbytesbuilder) ","b4xbytesbuilder",5,__ref.getField(false, "bi"),__ref,99);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (b4i_b4xbytesbuilder.class, "_subarray:" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));
