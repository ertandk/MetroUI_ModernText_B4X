...
public class b4i_b4xorderedmap_subs_0 {


public static RemoteObject  _class_globals(RemoteObject __ref) throws Exception{
 //BA.debugLineNum = 1;BA.debugLine="Sub Class_Globals";
 //BA.debugLineNum = 2;BA.debugLine="Private map As Map";
b4i_b4xorderedmap._map = RemoteObject.createNew ("B4IMap");__ref.setField("_map",b4i_b4xorderedmap._map);
 //BA.debugLineNum = 3;BA.debugLine="Private list As List";
b4i_b4xorderedmap._list = RemoteObject.createNew ("B4IList");__ref.setField("_list",b4i_b4xorderedmap._list);
 //BA.debugLineNum = 4;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _clear(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("Clear (b4xorderedmap) ","b4xorderedmap",7,__ref.getField(false, "bi"),__ref,26);
...
try {
		Debug.PushSubsStack("ContainsKey (b4xorderedmap) ","b4xorderedmap",7,__ref.getField(false, "bi"),__ref,46);
...
try {
		Debug.PushSubsStack("Get (b4xorderedmap) ","b4xorderedmap",7,__ref.getField(false, "bi"),__ref,37);
...
try {
		Debug.PushSubsStack("GetDataForSerializator (b4xorderedmap) ","b4xorderedmap",7,__ref.getField(false, "bi"),__ref,65);
...
Debug.JustUpdateDeviceLine();
if (true) return (RemoteObject.createNew("B4IArray").runMethod(false, "initObjectsWithData:", (Object)new RemoteObject[] {(__ref.getField(false,"_map" /*RemoteObject*/ )),((__ref.getField(false,"_list" /*RemoteObject*/ )).getObject())}));
...
try {
		Debug.PushSubsStack("GetDefault (b4xorderedmap) ","b4xorderedmap",7,__ref.getField(false, "bi"),__ref,42);
...
try {
		Debug.PushSubsStack("getKeys (b4xorderedmap) ","b4xorderedmap",7,__ref.getField(false, "bi"),__ref,32);
...
try {
		Debug.PushSubsStack("getSize (b4xorderedmap) ","b4xorderedmap",7,__ref.getField(false, "bi"),__ref,50);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.getField(false,"_map" /*RemoteObject*/ ).runMethod(true,"Size");
...
try {
		Debug.PushSubsStack("getValues (b4xorderedmap) ","b4xorderedmap",7,__ref.getField(false, "bi"),__ref,55);
if (RapidSub.canDelegate("getvalues")) { return __ref.runUserSub(false, "b4xorderedmap","getvalues", __ref);}
RemoteObject _res = RemoteObject.declareNull("B4IList");
RemoteObject _key = RemoteObject.declareNull("NSObject");
 BA.debugLineNum = 55;BA.debugLine="Public Sub getValues As List";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 56;BA.debugLine="Dim res As List";
Debug.JustUpdateDeviceLine();
_res = RemoteObject.createNew ("B4IList");Debug.locals.put("res", _res);
...
try {
		Debug.PushSubsStack("Initialize (b4xorderedmap) ","b4xorderedmap",7,__ref.getField(false, "bi"),__ref,6);
...
try {
		Debug.PushSubsStack("Put (b4xorderedmap) ","b4xorderedmap",7,__ref.getField(false, "bi"),__ref,12);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_map" /*RemoteObject*/ ).runMethod(true,"ContainsKey:",(Object)(_key)),b4i_main.__c.runMethod(true,"False"))) { 
...
try {
		Debug.PushSubsStack("Remove (b4xorderedmap) ","b4xorderedmap",7,__ref.getField(false, "bi"),__ref,20);
...
try {
		Debug.PushSubsStack("SetDataFromSerializator (b4xorderedmap) ","b4xorderedmap",7,__ref.getField(false, "bi"),__ref,70);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_map" /*RemoteObject*/ ,(_o.runMethod(false,"getObjectFast:", BA.numberCast(int.class, 0))));
 BA.debugLineNum = 73;BA.debugLine="list = o(1)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_list" /*RemoteObject*/ ).setObject (_o.runMethod(false,"getObjectFast:", BA.numberCast(int.class, 1)));
