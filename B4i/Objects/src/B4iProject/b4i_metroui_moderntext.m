...
B4IRDebugUtils.currentLine=720941;
 //BA.debugLineNum = 720941;BA.debugLine="Dim bc As ByteConverter";
_bc = [B4IByteConverter new];
B4IRDebugUtils.currentLine=720942;
 //BA.debugLineNum = 720942;BA.debugLine="Dim val(1) As Int";
_val = [[B4IArray alloc]initObjects:@[@((int) (1))] :@0 :nil];
B4IRDebugUtils.currentLine=720943;
 //BA.debugLineNum = 720943;BA.debugLine="val(0)=CircleColorProperty";
[_val setObjectFastN:(int) (0):@(__ref->__circlecolorproperty /*int*/ )];
B4IRDebugUtils.currentLine=720944;
 //BA.debugLineNum = 720944;BA.debugLine="Dim ColorSet As String = bc.HexFromBytes(bc.IntsT";
_colorset = [_bc HexFromBytes:[_bc IntsToBytes:_val]];
B4IRDebugUtils.currentLine=720945;
 //BA.debugLineNum = 720945;BA.debugLine="ColorSet=\"#\" & ColorSet.SubString(2)";
_colorset = [@[@"#",[_colorset SubString:(int) (2)]] componentsJoinedByString:@""];
B4IRDebugUtils.currentLine=720972;
 //BA.debugLineNum = 720972;BA.debugLine="Dim svg As SVG = SVGFromString($\"<?xml version=\"1";
self->__svg = [iSVG new];
self->__svg = [__ref _svgfromstring /*iSVG**/ :nil :([@[@"<?xml version=\"1.0\" encoding=\"UTF-8\" ?>\n",@"	<!DOCTYPE svg PUBLIC \"-//W3C//DTD SVG 1.1//EN\" \"http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd\">\n",@"	<svg width=\"128\" height=\"115\" viewBox=\"0 0 128 115\" preserveAspectRatio=\"none\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\">\n",@"	<g id=\"#fc7424ff\">\n",@"	<path fill=\"",[self->___c SmartStringFormatter:@"" :(NSObject*)(_colorset)],@"\" opacity=\"1.00\" d=\" M 37.22 3.35 C 45.06 -0.03 53.78 0.53 62.09 1.04 C 76.14 3.27 88.01 12.36 96.84 23.13 C 107.21 34.19 117.48 45.36 128.00 56.27 L 128.00 57.76 C 116.32 71.13 103.73 83.71 92.28 97.28 C 84.97 105.16 75.47 111.16 64.97 113.67 C 57.45 114.82 49.69 114.84 42.18 113.56 C 30.18 110.46 19.22 103.11 12.17 92.86 C 6.67 86.03 3.76 77.56 2.04 69.06 C 0.99 63.79 -0.11 58.36 0.85 52.98 C 2.18 45.24 3.63 37.35 7.29 30.31 C 13.44 18.03 24.11 7.82 37.22 3.35 Z\" />\n",@"	</g>\n",@"	</svg>\n",@""] componentsJoinedByString:@""])];
B4IRDebugUtils.currentLine=720981;
 //BA.debugLineNum = 720981;BA.debugLine="img.Bitmap=svg.Export(img.Width,img.Height)";
...
B4IRDebugUtils.currentLine=720983;
 //BA.debugLineNum = 720983;BA.debugLine="Log(File.ReadString(File.DirAssets,\"icon.svg\"))";
[self->___c LogImpl:@"1720983" :[[self->___c File] ReadString:[[self->___c File] DirAssets] :@"icon.svg"] :0];
B4IRDebugUtils.currentLine=720987;
 //BA.debugLineNum = 720987;BA.debugLine="Dim IconFont As B4XFont";
_iconfont = [B4XFont new];
B4IRDebugUtils.currentLine=720992;
 //BA.debugLineNum = 720992;BA.debugLine="IconFont = xui.CreateFont(Font.CreateFontAwesome(";
...
B4IRDebugUtils.currentLine=720996;
 //BA.debugLineNum = 720996;BA.debugLine="iconCircleB4X.SetTextAlignment(\"CENTER\",\"CENTER\")";
[__ref->__iconcircleb4x /*B4XViewWrapper**/  SetTextAlignment:@"CENTER" :@"CENTER"];
B4IRDebugUtils.currentLine=720997;
 //BA.debugLineNum = 720997;BA.debugLine="iconCircleB4X.TextColor=iconCircleColorProperty";
...
B4IRDebugUtils.currentLine=720998;
 //BA.debugLineNum = 720998;BA.debugLine="iconCircleB4X.TextSize=iconCircleSizeProperty";
[__ref->__iconcircleb4x /*B4XViewWrapper**/  setTextSize:(float) (__ref->__iconcirclesizeproperty /*int*/ )];
B4IRDebugUtils.currentLine=721000;
 //BA.debugLineNum = 721000;BA.debugLine="iconCircleB4X.Font=IconFont";
[__ref->__iconcircleb4x /*B4XViewWrapper**/  setFont:_iconfont];
B4IRDebugUtils.currentLine=721001;
 //BA.debugLineNum = 721001;BA.debugLine="iconCircleB4X.Text=\"\"";
[__ref->__iconcircleb4x /*B4XViewWrapper**/  setText:@""];
B4IRDebugUtils.currentLine=721003;
 //BA.debugLineNum = 721003;BA.debugLine="MyHintLabel.Text=HintNameProperty";
[__ref->__myhintlabel /*B4XViewWrapper**/  setText:__ref->__hintnameproperty /*NSString**/ ];
B4IRDebugUtils.currentLine=721004;
 //BA.debugLineNum = 721004;BA.debugLine="NormalHintArkaPlanUzunlugu=UzunlukHesapla(HintNam";
...
B4IRDebugUtils.currentLine=721005;
 //BA.debugLineNum = 721005;BA.debugLine="MyPanel.AddView(MyHintLabel, MyTextboxB4X.Left +";
...
B4IRDebugUtils.currentLine=721007;
 //BA.debugLineNum = 721007;BA.debugLine="MyPanel.AddView(MyErrorLabel,MyTextboxB4X.Left +";
...
B4IRDebugUtils.currentLine=721008;
 //BA.debugLineNum = 721008;BA.debugLine="MyErrorLabel.Visible=False";
[__ref->__myerrorlabel /*B4ILabelWrapper**/  setVisible:false];
B4IRDebugUtils.currentLine=721010;
 //BA.debugLineNum = 721010;BA.debugLine="MyErrorLabelB4X.TextColor=xui.Color_Red";
[__ref->__myerrorlabelb4x /*B4XViewWrapper**/  setTextColor:[__ref->__xui /*B4IXUI**/  Color_Red]];
B4IRDebugUtils.currentLine=721011;
 //BA.debugLineNum = 721011;BA.debugLine="MyErrorLabelB4X.TextSize=11";
[__ref->__myerrorlabelb4x /*B4XViewWrapper**/  setTextSize:(float) (11)];
B4IRDebugUtils.currentLine=721012;
 //BA.debugLineNum = 721012;BA.debugLine="MyErrorLabelB4X.Text=\"Lütfen E-Mail Adresinizi Gi";
[__ref->__myerrorlabelb4x /*B4XViewWrapper**/  setText:@"Lütfen E-Mail Adresinizi Giriniz!"];
B4IRDebugUtils.currentLine=721014;
 //BA.debugLineNum = 721014;BA.debugLine="End Sub";
return @"";
}
- (iSVG*)  _svgfromstring:(b4i_metroui_moderntext*) __ref :(NSString*) _s{
__ref = self;
B4IRDebugUtils.currentModule=@"metroui_moderntext";
if ([B4IDebug shouldDelegate: @"svgfromstring"])
	 {return ((iSVG*) [B4IDebug delegate:self.bi :@"svgfromstring:" :@[[B4I nilToNSNull:_s]]]);}
B4INativeObject* _svgimage = nil;
B4IRDebugUtils.currentLine=8388608;
 //BA.debugLineNum = 8388608;BA.debugLine="Private Sub SVGFromString(s As String) As SVG";
B4IRDebugUtils.currentLine=8388609;
 //BA.debugLineNum = 8388609;BA.debugLine="Dim svgimage As NativeObject";
_svgimage = [B4INativeObject new];
B4IRDebugUtils.currentLine=8388610;
 //BA.debugLineNum = 8388610;BA.debugLine="svgimage = svgimage.Initialize(\"SVGKImage\").RunMe";
_svgimage = [[[_svgimage Initialize:@"SVGKImage"] RunMethod:@"new" :(B4IArray*)(nil)] RunMethod:@"initWithData:" :[[B4IArray alloc]initObjectsWithData:@[[B4I nilToNSNull:[_svgimage ArrayToNSData:[_s GetBytes:@"utf8"]]]]]];
B4IRDebugUtils.currentLine=8388611;
 //BA.debugLineNum = 8388611;BA.debugLine="Dim svg As SVG = svgimage";
self->__svg = [iSVG new];
self->__svg = (iSVG*) [B4IObjectWrapper createWrapper:[iSVG new] object:(NSObject*)((_svgimage).object)];
B4IRDebugUtils.currentLine=8388612;
 //BA.debugLineNum = 8388612;BA.debugLine="Return svg";
if (true) return __ref->__svg /*iSVG**/ ;
