...
public static RemoteObject _name_text = RemoteObject.declareNull("b4a.example.metroui_moderntext");
public static RemoteObject _surname_text = RemoteObject.declareNull("b4a.example.metroui_moderntext");
public static RemoteObject _email_text = RemoteObject.declareNull("b4a.example.metroui_moderntext");
