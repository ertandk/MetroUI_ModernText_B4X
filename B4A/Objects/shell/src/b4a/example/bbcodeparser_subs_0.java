...
Debug.JustUpdateDeviceLine();
bbcodeparser.__c.runVoidMethod ("LogImpl","910092547",_s,bbcodeparser.__c.getField(false,"Colors").getField(true,"Red"));
...
Debug.JustUpdateDeviceLine();
bbcodeparser.__c.runVoidMethod ("LogImpl","910354749",RemoteObject.concat(RemoteObject.createImmutable("Font missing from TextEngine.CustomFonts: "),_name),0);
 }else {
