...
_vvvv0._vv3 /*b4a.example.b4xpagesmanager*/ (getActivityBA())._activity_actionbarhomeclick /*String*/ ();
...
if (true) return _vvvv0._vv3 /*b4a.example.b4xpagesmanager*/ (getActivityBA())._activity_keypress /*boolean*/ (_keycode);
...
_vvvv0._vv3 /*b4a.example.b4xpagesmanager*/ (getActivityBA())._activity_pause /*String*/ ();
...
_vvvv0._vv3 /*b4a.example.b4xpagesmanager*/ (getActivityBA())._vvvvvvvvvvvvvvv7 /*String*/ (_vvvv0._vv3 /*b4a.example.b4xpagesmanager*/ (getActivityBA())._vvvvvvvvvvvvvvv4 /*b4a.example.b4xpagesmanager._b4xpageinfo*/ (),"B4XPage_PermissionResult",new Object[]{(Object)(_permission),(Object)(_result)});
...
_vvvv0._vv3 /*b4a.example.b4xpagesmanager*/ (getActivityBA())._activity_resume /*String*/ ();
...
_vvvv0._vv3 /*b4a.example.b4xpagesmanager*/ (getActivityBA())._vvvvvvvvvvvvvv6 /*String*/ (_menu);
...
_vvvv0._vv3 /*b4a.example.b4xpagesmanager*/ (getActivityBA())._mainform_resize /*String*/ (_width,_height);
