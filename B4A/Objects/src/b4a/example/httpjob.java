...
public boolean _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = false;
public String _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = "";
public String _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = "";
public String _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = "";
public Object _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = null;
public String _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = "";
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = null;
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpResponse _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = null;
public Object _vvvvvv7 = null;
public String _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = "";
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0(String _link) throws Exception{
...
if ((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2).equals("") || _link.contains(":")) { 
if (true) return _link;};
 //BA.debugLineNum = 45;BA.debugLine="Return DefaultScheme & \"://\" & Link";
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2+"://"+_link;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = new Object();
 //BA.debugLineNum = 13;BA.debugLine="Private taskId As String";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = "";
 //BA.debugLineNum = 15;BA.debugLine="Private req As OkHttpRequest";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = new anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest();
 //BA.debugLineNum = 16;BA.debugLine="Public Response As OkHttpResponse";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = new anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpResponse();
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = "https://invalid-url/";
 //BA.debugLineNum = 31;BA.debugLine="Public DefaultScheme As String = \"https\"";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = "https";
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = BA.NumberToString(_id);
 //BA.debugLineNum = 308;BA.debugLine="CallSubDelayed2(target, \"JobDone\", Me)";
__c.CallSubDelayed2(ba,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5,"JobDone",this);
 //BA.debugLineNum = 309;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(String _link) throws Exception{
...
_link = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0(_link);
 //BA.debugLineNum = 255;BA.debugLine="req.InitializeDelete(Link)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.InitializeDelete(_link);
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.InitializeDelete(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1);
 };
 //BA.debugLineNum = 260;BA.debugLine="CallSubDelayed2(HttpUtils2Service, \"SubmitJob\", M";
__c.CallSubDelayed2(ba,(Object)(_vvvvv2.getObject()),"SubmitJob",this);
 //BA.debugLineNum = 261;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(String _link,String[] _parameters) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.InitializeDelete(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_link,_parameters));
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.InitializeDelete(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1,_parameters));
 };
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(String _link) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.InitializeGet(_link);
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.InitializeGet(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1);
 };
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4(String _link,String[] _parameters) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.InitializeGet(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_link,_parameters));
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.InitializeGet(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1,_parameters));
 };
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(String _link,String[] _parameters) throws Exception{
...
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6() throws Exception{
...
_b = __c.LoadBitmap(_vvvvv2._vvvv2 /*String*/ ,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6);
 //BA.debugLineNum = 324;BA.debugLine="Return b";
if (true) return _b;
 //BA.debugLineNum = 325;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7(int _width,int _height,boolean _keepaspectratio) throws Exception{
...
if (true) return __c.LoadBitmapResize(_vvvvv2._vvvv2 /*String*/ ,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6,_width,_height,_keepaspectratio);
 //BA.debugLineNum = 334;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0(int _width,int _height) throws Exception{
...
if (true) return __c.LoadBitmapSample(_vvvvv2._vvvv2 /*String*/ ,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6,_width,_height);
 //BA.debugLineNum = 330;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.streams.File.InputStreamWrapper  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1() throws Exception{
...
_in = __c.File.OpenInput(_vvvvv2._vvvv2 /*String*/ ,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6);
 //BA.debugLineNum = 341;BA.debugLine="Return In";
if (true) return _in;
 //BA.debugLineNum = 342;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2() throws Exception{
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3() throws Exception{
 //BA.debugLineNum = 282;BA.debugLine="Public Sub GetString As String";
 //BA.debugLineNum = 283;BA.debugLine="Return GetString2(\"UTF8\")";
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4("UTF8");
 //BA.debugLineNum = 284;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4(String _encoding) throws Exception{
...
_tr.Initialize2((java.io.InputStream)(__c.File.OpenInput(_vvvvv2._vvvv2 /*String*/ ,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6).getObject()),_encoding);
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(String _link) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.InitializeHead(_link);
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.InitializeHead(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1);
 };
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = _name;
 //BA.debugLineNum = 40;BA.debugLine="target = TargetModule";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = _targetmodule;
 //BA.debugLineNum = 41;BA.debugLine="End Sub";
return "";
}
public boolean  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6(anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper _stream,boolean _empty) throws Exception{
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7(String _link,byte[] _data) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.InitializePatch2(_link,_data);
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.InitializePatch2(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1,_data);
 };
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0(String _link,String _text) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7(_link,_text.getBytes("UTF8"));
 //BA.debugLineNum = 85;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(String _link,byte[] _data) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.InitializePost2(_link,_data);
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.InitializePost2(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1,_data);
 };
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(String _link,String _dir,String _filename) throws Exception{
int _length = 0;
anywheresoftware.b4a.objects.streams.File.InputStreamWrapper _in = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(_link,_out.ToBytesArray());
 }else {
 //BA.debugLineNum = 203;BA.debugLine="req.InitializePost(Link, In, length)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.InitializePost(_link,(java.io.InputStream)(_in.getObject()),_length);
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(String _link,anywheresoftware.b4a.objects.collections.Map _namevalues,anywheresoftware.b4a.objects.collections.List _files) throws Exception{
String _boundary = "";
...
_empty = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6(_stream,_empty);
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(_link,_stream.ToBytesArray());
 //BA.debugLineNum = 166;BA.debugLine="req.SetContentType(\"multipart/form-data; boundary";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.SetContentType("multipart/form-data; boundary="+_boundary);
 //BA.debugLineNum = 167;BA.debugLine="req.SetContentEncoding(\"UTF8\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.SetContentEncoding("UTF8");
 //BA.debugLineNum = 168;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4(String _link,String _text) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(_link,_text.getBytes("UTF8"));
 //BA.debugLineNum = 51;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(String _link,byte[] _data) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.InitializePut2(_link,_data);
 } 
       catch (Exception e5) {
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.InitializePut2(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1,_data);
 };
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6(String _link,String _text) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_link,_text.getBytes("UTF8"));
...
__c.File.Delete(_vvvvv2._vvvv2 /*String*/ ,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6);
