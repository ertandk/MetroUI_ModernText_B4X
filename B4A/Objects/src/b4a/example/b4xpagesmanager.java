...
public b4a.example.b4xorderedmap _vvvvvvvvvvvvvvvv6 = null;
public b4a.example.b4xorderedmap _vvvvvvvvvvvvvvvv7 = null;
public anywheresoftware.b4j.object.JavaObject _vvvvvvvvvvvvvvvv0 = null;
public b4a.example.b4xset _vvvvvvvvvvvvvvvvv1 = null;
public anywheresoftware.b4a.objects.B4XViewWrapper.XUI _vvvv5 = null;
public anywheresoftware.b4a.objects.ActivityWrapper _vvvvvvvvvvvvvvvvv2 = null;
public boolean _vvvvvvvvvvvvvvvvv3 = false;
public anywheresoftware.b4j.object.JavaObject _vvvvvvvvvvvvvvvvv4 = null;
public boolean _vvvvvvvvvvvvvvvvv5 = false;
public int _vvvvvvvvvvvvvvvvv6 = 0;
public b4a.example.b4xmainpage _vvv1 = null;
public String _vvvvvvvvvvvvvvvvv7 = "";
...
_vvvvvvvvvvvvvvv0(_vvvvvvvvvvvvvvv4(),"B4XPage_Disappear",(Object[])(__c.Null));
 //BA.debugLineNum = 634;BA.debugLine="BackgroundStateChanged(False)";
_vvvvvvvvvvvvv0(__c.False);
...
_shouldraise = _vvvvvvvvvvvvvvvvv5==__c.False;
 //BA.debugLineNum = 609;BA.debugLine="BackgroundStateChanged(True)";
_vvvvvvvvvvvvv0(__c.True);
...
_vvvvvvvvvvvvvvv7(_vvvvvvvvvvvvvvv4(),"B4XPage_Appear",(Object[])(__c.Null));
 };
 //BA.debugLineNum = 613;BA.debugLine="End Sub";
return "";
}
public b4a.example.b4xpagesmanager._b4amenuitem  _v7(Object _b4xpage,Object _title) throws Exception{
...
_vvvvvvvvvvvvvvv1(_b4xpage).Parent /*b4a.example.b4xpagesmanager._b4xpageparent*/ .MenuItems /*anywheresoftware.b4a.objects.collections.List*/ .Add((Object)(_mi));
...
if (_vvvvvvvvvvvvvvvv6._vvvvvvvvvvvv2 /*boolean*/ ((Object)(_idtolower))) { 
...
_vvvvvvvvvvvvvvvv6._vvvvvvvvvvvv7 /*String*/ ((Object)(_idtolower),(Object)(_vvvvvvvvvvvvvv4(_b4xpage,_idtolower,__c.False,(Object)(_id))));
 //BA.debugLineNum = 148;BA.debugLine="If IdToB4XPage.Size = 1 Then ShowPage(IdToLower)";
if (_vvvvvvvvvvvvvvvv6._getvvvvvvvvv7 /*int*/ ()==1) { 
_vvv3(_idtolower);};
...
_vvvvvvvvvvvvvv7(_vvvvvvvvvvvvvvv2(_id));
 //BA.debugLineNum = 154;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvv0(boolean _newstate) throws Exception{
String _ev = "";
b4a.example.b4xpagesmanager._b4xpageinfo _pi = null;
...
if (_vvvvvvvvvvvvvvvvv5==_newstate) { 
if (true) return "";};
 //BA.debugLineNum = 617;BA.debugLine="IsForeground = NewState";
_vvvvvvvvvvvvvvvvv5 = _newstate;
...
if (_vvvvvvvvvvvvvvvvv5) { 
_ev = "B4XPage_Foreground";}
else {
_ev = "B4XPage_Background";};
 //BA.debugLineNum = 620;BA.debugLine="For Each pi As B4XPageInfo In IdToB4XPage.Values";
{
final anywheresoftware.b4a.BA.IterableList group5 = _vvvvvvvvvvvvvvvv6._getvvvvvvvvvvvvv2 /*anywheresoftware.b4a.objects.collections.List*/ ();
...
if (_vvvv5.SubExists(ba,_pi.B4XPage /*Object*/ ,_ev,(int) (0))) { 
 //BA.debugLineNum = 622;BA.debugLine="LogEvent(pi, ev)";
_vvvvvvvvvvvvvvv6(_pi,_ev);
...
_vvvvvvvvvvvvvvvvv4 = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_jo.RunMethod("getActionBar",(Object[])(__c.Null))));
 //BA.debugLineNum = 102;BA.debugLine="If ActionBar.IsInitialized = False Then";
if (_vvvvvvvvvvvvvvvvv4.IsInitialized()==__c.False) { 
...
_vvvvvvvvvvvvvvvvv4 = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_jo.RunMethod("getSupportActionBar",(Object[])(__c.Null))));
 };
 };
...
__c.LogImpl("96422549","#SupportedOrientations attribute must be set to landscape or portrait.",_vvvv5.Color_Red);
 };
 };
 }
};
...
_vvvvvvvvvvvvvvvv6 = new b4a.example.b4xorderedmap();
 //BA.debugLineNum = 24;BA.debugLine="Private RootB4XToPage As B4XOrderedMap";
_vvvvvvvvvvvvvvvv7 = new b4a.example.b4xorderedmap();
 //BA.debugLineNum = 26;BA.debugLine="Private Context As JavaObject";
_vvvvvvvvvvvvvvvv0 = new anywheresoftware.b4j.object.JavaObject();
...
_vvvvvvvvvvvvvvvvv1 = new b4a.example.b4xset();
...
_vvvvvvvvvvvvvvvvv2 = new anywheresoftware.b4a.objects.ActivityWrapper();
 //BA.debugLineNum = 44;BA.debugLine="Public ShowUpIndicator As Boolean = True";
_vvvvvvvvvvvvvvvvv3 = __c.True;
 //BA.debugLineNum = 45;BA.debugLine="Public ActionBar As JavaObject";
_vvvvvvvvvvvvvvvvv4 = new anywheresoftware.b4j.object.JavaObject();
...
_pi = _vvvvvvvvvvvvvvv1(_b4xpage);
 //BA.debugLineNum = 211;BA.debugLine="If mStackOfPageIds.Contains(pi.Id) = False Then R";
if (_vvvvvvvvvvvvvvvvv1._vvvvvvvvvvvvv7 /*boolean*/ ((Object)(_pi.Id /*String*/ ))==__c.False) { 
if (true) return "";};
 //BA.debugLineNum = 212;BA.debugLine="If xui.IsB4i And GetTopPage <> pi Then";
if (_vvvv5.getIsB4i() && (_vvvvvvvvvvvvvvv4()).equals(_pi) == false) { 
...
if (true) return "";
 }else if(_vvvv5.getIsB4i() && _vvvvvvvvvvvvvvvvv1._getvvvvvvvvv7 /*int*/ ()==1) { 
...
if (_vvvv5.getIsB4A() && _vvvvvvvvvvvvvvvvv1._getvvvvvvvvv7 /*int*/ ()==1) { 
if (true) return "";};
 //BA.debugLineNum = 224;BA.debugLine="mStackOfPageIds.Remove(pi.Id)";
_vvvvvvvvvvvvvvvvv1._vvvvvvvvvvv2 /*String*/ ((Object)(_pi.Id /*String*/ ));
 //BA.debugLineNum = 225;BA.debugLine="If xui.IsB4A Then ShowPageImpl(GetTopPage)";
if (_vvvv5.getIsB4A()) { 
_vvvvvvvvvvvvvvvv1(_vvvvvvvvvvvvvvv4());};
 //BA.debugLineNum = 226;BA.debugLine="TopPageAppear";
_vvvvvvvvvvvvvvvv2();
 //BA.debugLineNum = 227;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvv2(b4a.example.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
if (_vvvvvvvvvvvvvvvvv1._getvvvvvvvvv7 /*int*/ ()==1) { 
...
public boolean  _vvvvvvvvvvvvvv3(b4a.example.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
if (true) return _vvvv5.SubExists(ba,_pi.B4XPage /*Object*/ ,"B4XPage_CloseRequest",(int) (0));
 //BA.debugLineNum = 533;BA.debugLine="End Sub";
return false;
}
public b4a.example.b4xpagesmanager._b4xpageinfo  _vvvvvvvvvvvvvv4(Object _b4xpage,String _id,boolean _created,Object _title) throws Exception{
...
public b4a.example.b4xpagesmanager._b4xpageparent  _vvvvvvvvvvvvvv5(Object _nativetype) throws Exception{
...
public String  _vvvvvvvvvvvvvv6(Object _menu) throws Exception{
b4a.example.b4xpagesmanager._b4xpageinfo _pi = null;
anywheresoftware.b4j.object.JavaObject _jo = null;
b4a.example.b4xpagesmanager._b4amenuitem _mi = null;
...
public String  _vvvvvvvvvvvvvv7(b4a.example.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
_pi.IsFirst /*boolean*/  = _vvvvvvvvvvvvvvvv6._getvvvvvvvvv7 /*int*/ ()==1;
 //BA.debugLineNum = 352;BA.debugLine="CreatePageImpl (pi)";
_vvvvvvvvvvvvvv0(_pi);
 //BA.debugLineNum = 353;BA.debugLine="pi.Created = True";
_pi.Created /*boolean*/  = __c.True;
 //BA.debugLineNum = 354;BA.debugLine="RootB4XToPage.Put(pi.Root, pi)";
_vvvvvvvvvvvvvvvv7._vvvvvvvvvvvv7 /*String*/ ((Object)(_pi.Root /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getObject()),(Object)(_pi));
 //BA.debugLineNum = 355;BA.debugLine="LogEvent(pi, \"B4XPage_Created\")";
_vvvvvvvvvvvvvvv6(_pi,"B4XPage_Created");
...
public String  _vvvvvvvvvvvvvv0(b4a.example.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
_pi.Root /*anywheresoftware.b4a.objects.B4XViewWrapper*/  = _vvvv5.CreatePanel(ba,"root");
...
_pi.Parent /*b4a.example.b4xpagesmanager._b4xpageparent*/  = _vvvvvvvvvvvvvv5((Object)(_vvvvvvvvvvvvvvvvv2.getObject()));
...
public b4a.example.b4xpagesmanager._b4xpageinfo  _vvvvvvvvvvvvvvv1(Object _page) throws Exception{
b4a.example.b4xpagesmanager._b4xpageinfo _pi = null;
...
{
final anywheresoftware.b4a.BA.IterableList group1 = _vvvvvvvvvvvvvvvv6._getvvvvvvvvvvvvv2 /*anywheresoftware.b4a.objects.collections.List*/ ();
...
if (true) return _vvvvvvvvvvvvvvv2(_id).B4XPage /*Object*/ ;
 //BA.debugLineNum = 393;BA.debugLine="End Sub";
return null;
}
public b4a.example.b4xpagesmanager._b4xpageinfo  _vvvvvvvvvvvvvvv2(String _id) throws Exception{
b4a.example.b4xpagesmanager._b4xpageinfo _pi = null;
...
_pi = (b4a.example.b4xpagesmanager._b4xpageinfo)(_vvvvvvvvvvvvvvvv6._vvvvvvvvv4 /*Object*/ ((Object)(_id.toLowerCase())));
...
__c.LogImpl("97471108","Ids: "+BA.ObjectToString(_vvvvvvvvvvvvvvvv6._getvvvvvvvvvvvvv1 /*anywheresoftware.b4a.objects.collections.List*/ ()),0);
 };
...
public b4a.example.b4xpagesmanager._b4xpageinfo  _vvvvvvvvvvvvvvv3(anywheresoftware.b4a.objects.B4XViewWrapper _root) throws Exception{
...
if (true) return (b4a.example.b4xpagesmanager._b4xpageinfo)(_vvvvvvvvvvvvvvvv7._vvvvvvvvv4 /*Object*/ ((Object)(_root.getObject())));
 //BA.debugLineNum = 406;BA.debugLine="End Sub";
return null;
}
public b4a.example.b4xpagesmanager._b4xpageinfo  _vvvvvvvvvvvvvvv4() throws Exception{
...
if (_vvvvvvvvvvvvvvvvv1._getvvvvvvvvv7 /*int*/ ()==0) { 
if (true) return (b4a.example.b4xpagesmanager._b4xpageinfo)(__c.Null);};
 //BA.debugLineNum = 591;BA.debugLine="Return IdToB4XPage.Get(mStackOfPageIds.AsList.Get";
if (true) return (b4a.example.b4xpagesmanager._b4xpageinfo)(_vvvvvvvvvvvvvvvv6._vvvvvvvvv4 /*Object*/ (_vvvvvvvvvvvvvvvvv1._vvvvvvvvvvvvv6 /*anywheresoftware.b4a.objects.collections.List*/ ().Get((int) (_vvvvvvvvvvvvvvvvv1._getvvvvvvvvv7 /*int*/ ()-1))));
 //BA.debugLineNum = 592;BA.debugLine="End Sub";
return null;
}
public void  _vvvvvvvvvvvvvvv5(b4a.example.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
parent._vvvvvvvvvvvvvvv6(_pi,"B4XPage_CloseRequest");
...
_vvvvvvvvvvvvvvvv6._initialize /*String*/ (ba);
 //BA.debugLineNum = 64;BA.debugLine="RootB4XToPage.Initialize";
_vvvvvvvvvvvvvvvv7._initialize /*String*/ (ba);
...
_vvvvvvvvvvvvvvvv0.InitializeContext(ba);
 //BA.debugLineNum = 70;BA.debugLine="mMainForm = Activity";
_vvvvvvvvvvvvvvvvv2 = _activity;
...
_nonmainpagewasadded = _vvvvvvvvvvvvvvvv6._getvvvvvvvvv7 /*int*/ ()>0;
 //BA.debugLineNum = 81;BA.debugLine="IdToB4XPage.Put(\"~~~~~temp~~~~\", CreateB4XPageInf";
_vvvvvvvvvvvvvvvv6._vvvvvvvvvvvv7 /*String*/ ((Object)("~~~~~temp~~~~"),(Object)(_vvvvvvvvvvvvvv4((Object)(_vvv1),"",__c.False,(Object)(""))));
 //BA.debugLineNum = 82;BA.debugLine="BackgroundStateChanged(True)";
_vvvvvvvvvvvvv0(__c.True);
 //BA.debugLineNum = 83;BA.debugLine="IdToB4XPage.Remove(\"~~~~~temp~~~~\")";
_vvvvvvvvvvvvvvvv6._vvvvvvvvvvv2 /*String*/ ((Object)("~~~~~temp~~~~"));
...
if (_vvvvvvvvvvvvvvvvv0==__c.False) { 
...
public String  _vvvvvvvvvvvvvvv6(b4a.example.b4xpagesmanager._b4xpageinfo _pi,String _ev) throws Exception{
String _msg = "";
...
_msg = ("*** "+__c.SmartStringFormatter("",(Object)(_pi.Id /*String*/ ))+": "+__c.SmartStringFormatter("",(Object)(_ev))+" "+__c.SmartStringFormatter("",(Object)(_vvvvvvvvvvvvvvvvv7))+"");
...
_vvvvvvvvvvvvvvv7(_vvvvvvvvvvvvvvv3((anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(__c.Sender(ba)))),"B4XPage_Resize",new Object[]{(Object)(_w),(Object)(_h)});
 //BA.debugLineNum = 586;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvv7(b4a.example.b4xpagesmanager._b4xpageinfo _targetpage,String _subname,Object[] _params) throws Exception{
int _length = 0;
...
_vvvvvvvvvvvvvvv6(_targetpage,_subname);
 //BA.debugLineNum = 550;BA.debugLine="If xui.SubExists(TargetPage.B4XPage, SubName, len";
if (_vvvv5.SubExists(ba,_targetpage.B4XPage /*Object*/ ,_subname,_length)==__c.False) { 
if (true) return "";};
...
public Object  _vvvvvvvvvvvvvvv0(b4a.example.b4xpagesmanager._b4xpageinfo _targetpage,String _subname,Object[] _params) throws Exception{
int _length = 0;
...
_vvvvvvvvvvvvvvvv1(_pi);
 //BA.debugLineNum = 176;BA.debugLine="mStackOfPageIds.Add(pi.Id)";
_vvvvvvvvvvvvvvvvv1._vvvvvvvvvvvvv5 /*String*/ ((Object)(_pi.Id /*String*/ ));
...
{
final anywheresoftware.b4a.BA.IterableList group8 = _vvvvvvvvvvvvvvvvv1._vvvvvvvvvvvvv6 /*anywheresoftware.b4a.objects.collections.List*/ ();
...
_pagetoremove = _vvvvvvvvvvvvvvv2(_id);
...
_vvvvvvvvvvvvvvvvv1._vvvvvvvvv3 /*String*/ ();
...
if (_vvvv5.getIsB4A() || _vvvv5.getIsB4J()) { 
...
public String  _vvvvvvvvvvvvvvvv1(b4a.example.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
_vvvvvvvvvvvvvvvvv2.AddView((android.view.View)(_pnl.getObject()),(int) (0),(int) (0),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (20)));
 //BA.debugLineNum = 340;BA.debugLine="pnl.SetLayoutAnimated(TransitionAnimationDuratio";
_pnl.SetLayoutAnimated(_vvvvvvvvvvvvvvvvv6,(int) (0),(int) (0),__c.PerXToCurrent((float) (100),ba),__c.PerYToCurrent((float) (100),ba));
 }else {
 //BA.debugLineNum = 342;BA.debugLine="mMainForm.AddView(pnl, 0, 0, 100%x, 100%y)";
_vvvvvvvvvvvvvvvvv2.AddView((android.view.View)(_pnl.getObject()),(int) (0),(int) (0),__c.PerXToCurrent((float) (100),ba),__c.PerYToCurrent((float) (100),ba));
 };
 //BA.debugLineNum = 347;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvv2() throws Exception{
b4a.example.b4xpagesmanager._b4xpageinfo _pi = null;
...
_vvvvvvvvvvvvvvv7(_pi,"B4XPage_Appear",(Object[])(__c.Null));
 };
 };
 //BA.debugLineNum = 295;BA.debugLine="If ShowUpIndicator And ActionBar.IsInitialized Th";
if (_vvvvvvvvvvvvvvvvv3 && _vvvvvvvvvvvvvvvvv4.IsInitialized()) { 
 //BA.debugLineNum = 296;BA.debugLine="ActionBar.RunMethod(\"setDisplayHomeAsUpEnabled\",";
_vvvvvvvvvvvvvvvvv4.RunMethod("setDisplayHomeAsUpEnabled",new Object[]{(Object)(_vvvvvvvvvvvvvvvvv1._getvvvvvvvvv7 /*int*/ ()>1)});
 };
...
public String  _vvvvvvvvvvvvvvvv3() throws Exception{
b4a.example.b4xpagesmanager._b4xpageinfo _pi = null;
...
_vvvvvvvvvvvvvvv0(_pi,"B4XPage_Disappear",(Object[])(__c.Null));
 };
 };
...
_vvvvvvvvvvvvvvvv0.RunMethod("invalidateOptionsMenu",(Object[])(__c.Null));
...
{
final anywheresoftware.b4a.BA.IterableList group5 = _vvvvvvvvvvvvvvvvv1._vvvvvvvvvvvvv6 /*anywheresoftware.b4a.objects.collections.List*/ ();
final int groupLen5 = group5.getSize()
;int index5 = 0;
;
for (; index5 < groupLen5;index5++){
...
_vvvvvvvvvvvvvvvvv7 = _sb.ToString();
