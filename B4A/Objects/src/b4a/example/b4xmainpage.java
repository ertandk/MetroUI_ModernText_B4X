...
public anywheresoftware.b4a.objects.B4XViewWrapper _vvvv4 = null;
...
_vvvv4 = new anywheresoftware.b4a.objects.B4XViewWrapper();
...
if ((_textbox._getvvvvvv2 /*String*/ ()).equals("")) { 
 //BA.debugLineNum = 36;BA.debugLine="TextBox.ShowError(HataMesajı)";
_textbox._vvvvv0 /*String*/ (_hatamesajı);
