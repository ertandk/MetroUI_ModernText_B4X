...
public int[] _vvvvvvvvv0 = null;
public int _vvvvvvvvvv1 = 0;
...
_vvvvvvvvv0 = new int[(int) (__c.Bit.ShiftRight(_vvvvvvvvvv1,(int) (5))+1)];
;
 //BA.debugLineNum = 59;BA.debugLine="End Sub";
return "";
}
public boolean  _vvvvvvvvv4(int _index) throws Exception{
int _dindex = 0;
int _offset = 0;
int _blockvalue = 0;
...
_blockvalue = _vvvvvvvvv0[_dindex];
...
public String  _vvvvvvvvv6(int _index,boolean _value) throws Exception{
int _dindex = 0;
int _offset = 0;
int _blockvalue = 0;
...
_vvvvvvvvv0[_dindex] = _newblockvalue;
