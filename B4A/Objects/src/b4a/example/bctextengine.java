...
_line.Height /*int*/  = (int) (__c.Max(_line.MaxHeightAboveBaseLine /*int*/ +_prevlinebelowbaselineheight+_mingapbetweenlines*_mscale,_mspacebetweenlines*_p.Style /*b4a.example.bctextengine._bcparagraphstyle*/ .LineSpacingFactor /*float*/ ));
 };
