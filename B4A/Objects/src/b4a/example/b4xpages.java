...
public static Object _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = null;
public static b4a.example.b4xpagesdelegator _v5 = null;
...
public static b4a.example.b4xpagesmanager._b4amenuitem  _v7(anywheresoftware.b4a.BA _ba,Object _b4xpage,Object _title) throws Exception{
...
if (true) return _vv3(_ba)._v7 /*b4a.example.b4xpagesmanager._b4amenuitem*/ (_b4xpage,_title);
...
public static b4a.example.b4xpagesmanager  _vv3(anywheresoftware.b4a.BA _ba) throws Exception{
 //BA.debugLineNum = 14;BA.debugLine="Public Sub GetManager As B4XPagesManager";
 //BA.debugLineNum = 15;BA.debugLine="Return mPM";
if (true) return (b4a.example.b4xpagesmanager)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3);
...
if (true) return _vv3(_ba)._vvvvvvvvvvvvvvv1 /*b4a.example.b4xpagesmanager._b4xpageinfo*/ (_b4xpage).Parent /*b4a.example.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4a.objects.ActivityWrapper*/ ;
...
if (true) return _vv3(_ba)._vvvvvvvvvvvvvvv1 /*b4a.example.b4xpagesmanager._b4xpageinfo*/ (_b4xpage).Id /*String*/ ;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = _pm;
...
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 instanceof b4a.example.b4xpagesmanager;
 //BA.debugLineNum = 11;BA.debugLine="End Sub";
return false;
}
public static b4a.example.b4xmainpage  _vvv1(anywheresoftware.b4a.BA _ba) throws Exception{
...
if (true) return _vv3(_ba)._vvv1 /*b4a.example.b4xmainpage*/ ;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = new Object();
 //BA.debugLineNum = 3;BA.debugLine="Public Delegate As B4XPagesDelegator";
_v5 = new b4a.example.b4xpagesdelegator();
